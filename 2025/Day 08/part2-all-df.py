...
def main() -> int:
    ...
    # TODO: I think this worked and I misread the assignment. For some reason, I was looking for the last two
    # TODO: boxes added to the circuit. That's not the ask. The ask is for the last box connected and which box it
    # TODO: is connected to. :(
