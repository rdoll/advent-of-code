...
<p>Cephalopod math doesn't look that different from normal math. The math worksheet (your puzzle input) consists of a list of <em>problems</em>; each problem has a group of numbers that need to either be either <em>added</em> (<code>+</code>) or <em>multiplied</em> (<code>*</code>) together.</p>
